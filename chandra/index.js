...
var tour = {
  preOrbit:{dur: "1000",
            ...
            noClickText: "Hello from the Chandra X-Ray Observatory. \nCome along on a brief tour.",
            pause: 6000,
            textOffset: {x: 0, y: -0.1, z: -0.3},
  ...
  tour1:{dur: "7000",
         audio: "",
         playWhile: false,
         text: "X-rays are too energetic to bounce off traditional\n mirrors like we use to see our reflection.\n Instead, Chandra has nested barrel-shaped mirrors\n that allow the X-rays to skip like a pebble\n across a pond and then focus on the detector\n 10 meters away.",
         noClickText: "X-rays are too energetic\n to bounce off mirrors\n like we use to see our reflection.\n Instead, Chandra has barrel-shaped\n mirrors that allow the\n X-rays to skip like a pebble\n across a pond and then focus\n on the detector\n 10 meters away.",
         pause: 9000,
         textOffset: {x: 0.2, y: -0.1, z: 0.1},
         textRotate: {x: -10, y: -90, z: 0},
         next: "tour2",
        },
  tour2:{dur: "5000",
         audio: "",
         playWhile: false,
         text: "Chandra uses cameras and \nother instruments at the far end\n to analyze the X-rays\n coming from deep space.",
         noClickText: "Chandra uses cameras and \nother instruments at the far end\n to analyze the X-rays\n coming from deep space.",
         pause: 6000,
         textOffset: {x: .3, y: 0, z: 0},
  ...
  tour3:{dur: "5000",
         audio: "",
         playWhile: false,
         text: "Chandra's solar panels collect power for the telescope's detectors and its radio communication with the Earth.  The electricity is also used to heat the mirrors to keep them from deforming in the cold temperatures of space.",
         noClickText: "Chandra's solar panels collect power\n for the telescope's detectors\n and its radio communication with the Earth.\n  The electricity is also used\n to heat the mirrors to keep them from\n deforming in the cold temperatures\n of space.",
         pause: 6000,
         textOffset: {x: 0.4, y: -0.1, z: -.3},
         textRotate: {x: 0, y: -40, z: 0},
         next: "tour4",
        },
  tour4:{dur: "6000",
         audio: "",
         playWhile: false,
         text: "In order to provide motion to the observatory, Chandra has two different sets of thrusters. Chandra aims with high-precision gyroscopes.",
         noClickText: "In order to provide motion to the \nobservatory, Chandra has two different\n sets of thrusters. Chandra aims with\n high-precision gyroscopes.",
         pause: 6000,
         textOffset: {x: 0.3, y: -0.08, z: -0.2},
  ...
  tour5:{dur: "1500",
         audio: "",
         playWhile: false,
         text: "The antennas on Chandra are its link to NASA's Deep Space Network, a series of three radio dishes located at different parts of Earth. The system eventually delivers the data to the Chandra X-ray Center, in Cambridge, Massachusetts.",
         noClickText: "The antennas on Chandra are\n its link to NASA's Deep Space\n Network, a series of three radio\n dishes located at different parts of Earth.\n The system eventually delivers the\n data to the Chandra X-ray Center,\n in Cambridge, Massachusetts.",
         pause: 6000,
         textOffset: {x: .3, y: -0.02, z: 0.2},
  ...
  init: function() {
    ...
    var moveEndHandler = function(event) {
      ...
      textPos = {x: pos.x + offset.x,
                 y: pos.y + offset.y + 1.6,  // to accommodate camera rig
                 z: pos.z + offset.z};
